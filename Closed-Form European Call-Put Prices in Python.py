from math import exp, log, pidef norm_pdf(x):
...
def norm_cdf(x):
    ...
    #Create a second file called closed_form.py. It should reside in the same file directory as the statistics.py file so importing the following syntax works correctly.
